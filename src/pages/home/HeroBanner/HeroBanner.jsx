...
function HeroBanner() {
  ...
  return (
    <div className='hero_banner w-full h-[450px] flex items-center relative bg-black top-[-70px]'>
        ...
        <div className='wrapper container mx-auto z-10'>
            <div className="hero_banner_content p-4">
                ...
                <div className='search w-full flex justify-center mt-5'>
                    <input type='text' placeholder='Search for a movie, tv show, person......' className='rounded-s-2xl py-2 px-4 bg-white outline-none text-sm w-full md:w-2/4' onKeyUp={handleSearchInput} onChange={(e) => setQuery(e.target.value)}/>
                    <button className='bg-gradient-to-r from-neutral-700 via-slate-800 to-black text-white py-2 px-4 rounded-e-2xl text-sm '>Search</button>
                </div>
            </div>
        </div>
    </div>
